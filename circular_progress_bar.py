...
class CircularProgressBar(Widget):
    ...
    def __init__(self, **kwargs):
        ...
        self._text_label =  Label(text="{}%", font_size=40, color=(0, 0, 0, 1))
        ...
        self._default_label_text =  Label(text="{}%", font_size=40).text
    ...
    def label(self, value: Label):
        if not isinstance(value, Label):
            raise TypeError("Label must be fromn kivy.core.text, not {}!".format(type(value)))
        else:
